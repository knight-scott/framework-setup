...
install_packages android-sdk bat bitwarden blackman chromium code docker fzf github-cli gobuster htop hydra lightdm lightdm-slick-greeter lolcat nmap obsidian python python-pip qFlipper rpi-imager sqlmap starship subfinder terraform tree vim wireshark
